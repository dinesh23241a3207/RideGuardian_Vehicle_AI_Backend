...
#
# Identifies WHICH vehicle part is visible in a photograph.
#
# Examples:
#   Front-wheel
#   Back-wheel
...
# IMPORTANT:
# Your previous Windows DataLoader worker crash is avoided.
NUM_WORKERS = 0
...
print("=" * 70)
print(
    "RIDEGUARDIAN VEHICLE PART CoAtNet"
)
print("=" * 70)
...
# CLASS WEIGHTS
#
# Useful if some vehicle-part classes contain fewer images.
# ============================================================
...
print("=" * 70)
print(
    "STARTING VEHICLE PART CoAtNet TRAINING"
)
print("=" * 70)
...
print("=" * 70)
print(
    "LOADING BEST VEHICLE PART MODEL"
)
print("=" * 70)
...
print("=" * 70)
print(
    "FINAL VEHICLE PART TEST EVALUATION"
)
print("=" * 70)
...
print("=" * 70)
print(
    "VEHICLE PART CLASSIFICATION REPORT"
)
print("=" * 70)
...
print("=" * 70)
print(
    "VEHICLE PART CoAtNet TRAINING COMPLETE"
)
print("=" * 70)
